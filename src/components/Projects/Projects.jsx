...
R-1&scaling=min-zoom&content-scaling=fixed&starting-point-nodeid=38%3A" myBrand={pic2}/>
...
U-1&scaling=min-zoom&content-scaling=fixed" myBrand={pic3}/>
      </div>
    </div>
  )
}
